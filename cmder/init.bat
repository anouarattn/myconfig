...
@doskey /EXENAME=cmd.exe cdd=cd C:\Users\anouarattn\Dropbox\
@doskey /EXENAME=cmd.exe cddp=cd C:\Users\anouarattn\Dropbox\project
@doskey /EXENAME=cmd.exe st=sublime_text.exe $*
